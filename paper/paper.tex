...
\toprule
\textbf{Model} & \textbf{Developer} & \textbf{Openness} & \textbf{Context} & \textbf{Latency (s)} & \textbf{Input \$/M} & \textbf{Output \$/M} & \textbf{Notes} \\
\midrule
\textbf{Gemini 2.5 Flash Lite} & Google & Proprietary & 1.05M & 0.42 & 0.10 & 0.40 & Fast, low-cost; optimized for captioning. \\
\textbf{Llama 4 Maverick} & Meta & Open weights & 1.05M & 0.56 & 0.15 & 0.60 & Multilingual, multimodal reasoning. \\
\textbf{GPT-4o mini} & OpenAI & Proprietary & 128K & 0.58 & 0.15 & 0.60 & Compact GPT-4o variant; strong factual grounding. \\
\textbf{Qwen3 VL 8B Instruct} & Alibaba & Open-weight & 131K & 1.29 & 0.08 & 0.50 & Robust open baseline with OCR features. \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lrrrr}
\toprule
\textbf{Model} & \textbf{Coverage (\%)} & \textbf{Throughput (items/s)} & \textbf{Median Latency (s)} & \textbf{Mean Cost (USD/item)} \\
\midrule
...
\paragraph{Example for Factually Wrong Text}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./images/m92410.jpg}
\caption{Faltblatt der Gruppe ‹Freiräume für Frauen› (FFF) (\href{https://forschung.stadtgeschichtebasel.ch/items/abb92410.html\#m92410}{m92410})}
\end{figure}
...
\paragraph{Example for Reproduction of Stereotypes}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./images/m91960.jpg}
\caption{‹Gegen den Eisenbahnhandel›, anonyme antisemitische Karikatur in der Extraausgabe der Basler ‹Allgemeinen Schweizer Zeitung› vom 14. Februar 1898 (\href{https://forschung.stadtgeschichtebasel.ch/items/abb92410.html\#m92410}{m91960})}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{Translation}: \enquote{Antisemitic caricature on the nationalization of the railways 1898. Left: Defensive Helvetia forces a kneeling moneylender down. Right: Kneeling Helvetia asks a rich Jew for money. Contrasting depiction of the referendum on the nationalization of the railways}
...
\paragraph{Example for Selective Description}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{./images/m88415_1.jpg}
\caption{Zuschauerzahlen von FC Basel und Konzerten im St. Jakob-Stadion, 1960–2022 (\href{https://forschung.stadtgeschichtebasel.ch/items/abb88415.html\#m88415_1}{m88415\_1})}
\end{figure}
...
\toprule
\textbf{Type} & \textbf{Protohistory} & \textbf{Antiquity} & \textbf{Middle Ages} & \textbf{Early Modern Period} & \textbf{19th century} & \textbf{20th century} & \textbf{21st century} \\
\midrule
...
\midrule
\textbf{Findable (FAIR)} & Repository indexed on GitHub and Zenodo with persistent DOI; structured metadata and semantic filenames. \\
\textbf{Accessible} & Publicly accessible under AGPL-3.0 (code) and CC BY 4.0 (data, documentation). No authentication barriers. \\
\textbf{Interoperable} & Machine-readable CSV, JSONL, and Parquet formats; consistent column schemas; human- and machine-readable metadata. \\
\textbf{Reusable} & Version-controlled pipeline, deterministic random seeds, explicit dependencies, and complete provenance logs. \\
\textbf{Collective Benefit (CARE)} & Focus on accessibility and inclusion in digital heritage; results aim to improve equitable access to cultural data. \\
\textbf{Authority to Control} & No personal or culturally sensitive material; contributors retain authorship and citation credit. \\
\textbf{Responsibility} & Transparent methodological reporting and ethical safeguards for AI-assisted heritage interpretation. \\
\textbf{Ethics} & Evaluation limited to non-personal, publicly available heritage materials; compliance with institutional research ethics guidelines. \\
\bottomrule
\end{tabular}
\end{table}
